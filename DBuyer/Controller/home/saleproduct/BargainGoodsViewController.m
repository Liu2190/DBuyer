...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(source == CharacteristicsGoods || source == TheNewMonthly || source == BargainGoods || source == SeasonalGoods)
    {
        ...
        [[TServerFactory getServerInstance:@"TProductServer"]doGetPromotionalProductByID:spID AndCategoryID:categoryId andCallback:^(NSDictionary *dict){
